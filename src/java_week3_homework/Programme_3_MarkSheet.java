...
public class Programme_3_MarkSheet {
    ...
    public static void printTheMarkSheet(String name, int rollNumber, int mathsMarks, int scienceMarks, int englishMarks, int total, int percentage, String result, String grade) {
        System.out.println("------------------------------------");
        System.out.println("|                                   |");
